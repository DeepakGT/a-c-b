module Snowflake
  module LocationSpecificAppointmentSeed
    class << self
      def call(username, password, clinic_id)
        location_specific_seed_scheduling_data(username, password, clinic_id)
      end
      ...
      def location_specific_seed_scheduling_data(username, password, clinic_id)
        ...
        Loggers::SnowflakeSchedulingLoggerService.call(count, "#{count} schedulings must be seeded.")
