...
RSpec.describe RenderAppointmentsWorker, type: :job do
  ...
  # let(:scheduled_job) { described_class.perform_in(time, 'RenderAppointments', true) }
  # describe 'testing worker' do
  #   it "RenderAppointmentsWorker is enqueued in RenderAppointments queue" do 
  #     described_class.perform_async
  #     assert_equal "RenderAppointments", described_class.queue
  #   end
  ...
  #       expect(described_class).to have_enqueued_sidekiq_job('RenderAppointments', true)
  #     end
  #   end
  # end
