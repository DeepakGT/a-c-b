...
if ((@client&.non_early_authorizations_except_97151&.present? || !@client&.authorization_includes_97151&.present? ) || (@client&.early_authorizations&.present? && @client&.funding_source_ids&.count==FundingSource.non_billable_funding_sources.count)) || @client&.days_since_creation>180 || Service.early_services.blank?
