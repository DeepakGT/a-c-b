  ...
  describe "GET #index" do
    context "when sign in" do
      ...
      context "when search_value is present" do
        ...
        let!(:client1) {create(:client, clinic_id: clinic.id, first_name: 'test', gender: 0, bcba_id: nil)}
        let!(:client2) {create(:client, clinic_id: clinic.id, last_name: 'test', gender: 0, bcba_id: nil)}
