module Snowflake
  module LocationSpecificAuthorizationSeed
    class << self
      def call(username, password, clinic_id)
        location_specific_seed_client_enrollment_service_data(username, password, clinic_id)
      end
      ...
      def location_specific_seed_client_enrollment_service_data(username, password, clinic_id)
        ...
        student_services.each_index do |i|
          student_service = student_services[i]
