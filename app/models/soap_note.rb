  ...
  def validate_signatures
    if scheduling.staff.role_name=='bcba'
      ...
      if user.role_name=='bcba' && self.bcba_signature==true && self.bcba_signature_author_name=="#{user.first_name} #{user.last_name}"
        if !(self.scheduling.client_enrollment_service.staff.include?(user)) && scheduling.staff_id!=current_user.id && scheduling.client_enrollment_service.client_enrollment.client.bcba_id!=current_user.id
