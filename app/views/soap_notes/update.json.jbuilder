...
json.data do
  ...
  elsif @soap_note.scheduling.unrendered_reasons.present?
    json.rendered_message "Appointment cannot be rendered because #{@soap_note.scheduling.unrendered_reasons.to_human_string}"
  end
end
