    ...
    class << self
      ...
      def sync_client_data(start_date)
        ...
        client_data_array.each_index do |i|
          ...
          if (client_data['firstName']=='Denali' && client_data['lastName']=='Page' && client_data['dateOfBirth']&.to_time&.strftime('%Y-%m-%d')=='2015-01-15') || (client_data['firstName']=='Milton' && client_data['lastName']=='Moye' && client_data['dateOfBirth']&.strftime('%Y-%m-%d')=='2018-06-20')
            ...
            if client_data['firstName']=='Alaiah' && client_data['lastName']=='Vasquez' && client_data['dateOfBirth']&.to_time&.strftime('%Y-%m-%d')=='2018-02-22'
              client_data['lastName'] = 'Vazquez' 
            elsif client_data['firstName']=='Jayce' && client_data['lastName']=='Giles' && client_data['dateOfBirth']&.to_time&.strftime('%Y-%m-%d')=='2016-12-18'
              client_data['lastName'] = 'Gilles'
            elsif client_data['firstName']=='Matthias' && client_data['lastName']=='Rumell Buss' && client_data['dateOfBirth']&.to_time&.strftime('%Y-%m-%d')=='2004-09-24'
              client_data['lastName'] = 'Buss'
            elsif client_data['firstName']=='Maley' && client_data['lastName']=='Soucy' && client_data['dateOfBirth']&.to_time&.strftime('%Y-%m-%d')=='2002-09-02'
