...
RSpec.describe MetaDataController, type: :controller do
  ...
  describe "GET #replaceable_authorizations_list" do
    context "when sign in" do
      ...
      let!(:client_enrollment1){create(:client_enrollment, client_id: client.id, source_of_payment: 'insurance', funding_soucre_id: non_billable_funding_source.id)}
      let!(:client_enrollment2){create(:client_enrollment, client_id: client.id, source_of_payment: 'insurance', funding_soucre_id: funding_source1.id)}
      let!(:client_enrollment3){create(:client_enrollment, client_id: client.id, source_of_payment: 'insurance', funding_soucre_id: funding_source2.id)}
      ...
      let!(:client_enrollment_service2){create(:client_enrollment_service, client_enrollment_id: client_enrollment2.id, service_id: service1.id)}
      let!(:client_enrollment_service3){create(:client_enrollment_service, client_enrollment_id: client_enrollment3.id, service_id: service2.id)}
